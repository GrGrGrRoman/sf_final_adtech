...
SF-Adtech - это приложение, выполненное по стандартам Объектно-ориентированного программирования и MVC - module - view - controller. Используется пакет RedBean для работы с базой данных. В остальном - "чистый" PHP
...
Настройки redbean находятся в файле /core/model.php
В папке с проектом есть тестовая база данных adtech.sql, для демонстрации возможностей, рекомендуется ее установить. 
